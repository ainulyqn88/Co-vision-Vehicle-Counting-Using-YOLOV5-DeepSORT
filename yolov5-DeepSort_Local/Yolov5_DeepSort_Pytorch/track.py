    ...
    for frame_idx, (path, img, im0s, vid_cap, s) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if show_vid:
                ...
                color=(0,255,0) #warna ungu
                color_text=(0,255,0) #warna hijau
                #garis horizontal
                start_point = (0, h-300) 
                end_point = (w, h-300)
                #garis vertikal
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='videos/video9.mp4', help='source')  # file/folder, 0 for webcam
